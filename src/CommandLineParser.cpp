...
CommandLineParser::CommandLineParser(QObject* _parent) : QObject(_parent), m_parser(), m_helpOption(m_parser.addHelpOption()),
  ...
  m_p2pBindPortOption("p2p-bind-port", tr("Port for p2p network protocol"), tr("port"), QString::number(VarNote::P2P_DEFAULT_PORT)),
  ...
  m_parser.setApplicationDescription(tr("Varcoin wallet"));
