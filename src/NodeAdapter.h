...
public:
  ...
  VarNote::IWalletLegacy* createWallet() const;
...
private:
  ...
  VarNote::CoreConfig makeCoreConfig() const;
  VarNote::NetNodeConfig makeNetNodeConfig() const;
...
Q_SIGNALS:
  ...
  void initNodeSignal(Node** _node, const VarNote::Currency* currency, INodeCallback* _callback, Logging::LoggerManager* _loggerManager,
