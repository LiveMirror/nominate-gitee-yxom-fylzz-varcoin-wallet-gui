...
class WalletAdapter : public QObject, public VarNote::IWalletLegacyObserver {
  Q_OBJECT
...
public:
  ...
  bool getTransaction(VarNote::TransactionId& _id, VarNote::WalletLegacyTransaction& _transaction);
  bool getTransfer(VarNote::TransferId& _id, VarNote::WalletLegacyTransfer& _transfer);
  bool isOpen() const;
  void sendTransaction(const QVector<VarNote::WalletLegacyTransfer>& _transfers, quint64 _fee, const QString& _payment_id, quint64 _mixin);
  ...
  void externalTransactionCreated(VarNote::TransactionId _transaction_id) Q_DECL_OVERRIDE;
  void sendTransactionCompleted(VarNote::TransactionId _transaction_id, std::error_code _result) Q_DECL_OVERRIDE;
  void transactionUpdated(VarNote::TransactionId _transaction_id) Q_DECL_OVERRIDE;
...
private:
  ...
  void onWalletSendTransactionCompleted(VarNote::TransactionId _transaction_id, int _error, const QString& _error_text);
...
Q_SIGNALS:
  ...
  void walletTransactionCreatedSignal(VarNote::TransactionId _transaction_id);
  void walletSendTransactionCompletedSignal(VarNote::TransactionId _transaction_id, int _error, const QString& _error_text);
  void walletTransactionUpdatedSignal(VarNote::TransactionId _transaction_id);
