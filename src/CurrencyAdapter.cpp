...
CurrencyAdapter::CurrencyAdapter() : m_currency(VarNote::CurrencyBuilder(LoggerAdapter::instance().getLoggerManager()).currency()) {
}

CurrencyAdapter::~CurrencyAdapter() {
}

const VarNote::Currency& CurrencyAdapter::getCurrency() {
  return m_currency;
}
...
bool CurrencyAdapter::validateAddress(const QString& _address) const {
  VarNote::AccountPublicAddress internalAddress;
