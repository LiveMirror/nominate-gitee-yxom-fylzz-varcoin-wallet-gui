...
typedef QPair<VarNote::TransactionId, VarNote::TransferId> TransactionTransferId;
...
private:
  ...
  QHash<VarNote::TransactionId, QPair<quint32, quint32> > m_transactionRow;
  ...
  QVariant getUserRole(const QModelIndex& _index, int _role, VarNote::TransactionId _transactionId, VarNote::WalletLegacyTransaction& _transaction,
    VarNote::TransferId _transferId, VarNote::WalletLegacyTransfer& _transfer) const;

  void reloadWalletTransactions();
  void appendTransaction(VarNote::TransactionId _id, quint32& _row_count);
  void appendTransaction(VarNote::TransactionId _id);
  void updateWalletTransaction(VarNote::TransactionId _id);
