...
void SendFrame::sendClicked() {
  QVector<VarNote::WalletLegacyTransfer> walletTransfers;
  Q_FOREACH (TransferFrame * transfer, m_transfers) {
    ...
    VarNote::WalletLegacyTransfer walletTransfer;
...
void SendFrame::sendTransactionCompleted(VarNote::TransactionId _id, bool _error, const QString& _errorText) {
  Q_UNUSED(_id);
  if (_error) {
    QCoreApplication::postEvent(
      &MainWindow::instance(),
